							...
							<div class="topbar">
								...
								<div class="topbar-item">
									<div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
										...
										<span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3" id="session"></span>
									</div>
								</div>
								<!--end::User-->
								<!--begin::Quick panel-->
								<div class="topbar-item">
									<div class="btn btn-icon btn-clean btn-lg mr-1" data-toggle="tooltip" title="Logout? Please Click Here" id="kt_quick_panel_toggle">
														...
														<div class="d-flex align-items-center pb-9">
																<div class="symbol symbol-45 symbol-light mr-4">
																	...
																	<div class="d-flex flex-column flex-grow-1">
																		...
																		<span class="font-weight-bolder label label-xl label-light-danger label-inline px-3 py-1 min-w-45px step-link" id="step2">Not Completed</span>
																	</div>
														</div>
														<!-- tambahan -->
														<div class="d-flex align-items-center pb-9">
																...
																<thead class="ad-header" style="margin-top:10px; padding: 13px;">
																	...
																	<tbody>
																		...
																		<tr>
																			...
																			<td><a href="http://localhost/pascav2/public/accept"><span class="label label-success label-pill label-inline mr-2">Accept</a></span><a><span class="label label-danger label-pill label-inline mr-2" id="updreject">Reject</span></a></td>
																		</tr>
																		<!-- <tr>
																			<td class="pl-0">25/10/2024</td>
