...
class DashboardController extends ResourceController
{
    ...
    public function countDisplayDashboard()
    {
        ...
        $db = Config::connect();
            ...
            p001knegerit IS NULL OR p001poskodt IS NULL OR p001notel IS NULL OR p001nohp IS NULL OR p001kcacat IS NULL OR p001upgambar IS NULL OR p001laluanmohon IS NULL OR p001notelt IS NULL) AND p00daftar.p00username = '$user' AND p00daftar.p000statsahreg = 1");
